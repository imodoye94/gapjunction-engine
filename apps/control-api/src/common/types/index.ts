// Common types and interfaces for the Control API
...
export type WebSocketMessageType = 
  | 'enroll' | 'auth' | 'auth_ok' | 'auth_error'
  | 'heartbeat' | 'pong'
  | 'run_test' | 'test_result'
  | 'deploy' | 'deploy_result'
  | 'attestation'
  | 'log_batch' | 'metrics_batch'
  | 'drain_ack' | 'drain_error'
  | 'update_agent' | 'update_result'
  | 'rotate_enrollment' | 'rotate_result'
